...
$total_count=count_seltable("property");
//find all records.
...
$vper_page=20;	
$vtotal_count=count_svalue("property",'property_id',$_GET['propertyno']);	
...
echo "<b><li";
echo "><a href=\"propertylist.php?subj=".urlencode($subject["subject_id"])."\">
...
<div id="rightcol"><br/>
<p >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bold><i>Input the property Number below to search</i></bold></p>
<h1>
...
<div class="fashioncol">
 ...
 <form action="propertylist.php?" enctype="multipart/form-data" method="GET" border="2px">
 <table>
 <tr>
 <th><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Property No.:<input type="text" name="propertyno" value=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
 <th>&nbsp;&nbsp;<input type="submit" class="btn btn-success" name="search" value="Search"/></th>
 </tr>
 </table>
</form><br/>
<div id="printform">
 <p><div id="parhead" align="center">&nbsp;&nbsp;&nbsp;<img src="gallery/propertylist.jpg" alt="logo"></div></p><br/>
<?php 
if(isset($_GET['propertyno'])){
...
echo "<th><b>Property location</b></th>";
echo "<th><b>No of Units</b></th>";
echo "<th><b>Property Worth</b></th>";
echo "<th><b>&nbsp;</b></th>";
echo "</tr>";

$page_set=get_table('property','property_id',$_GET['propertyno']);
while($page=mysqli_fetch_array($page_set,MYSQLI_ASSOC)){	
echo "<tr>";
echo "<td>{$page['date']}</td>";
echo "<td>{$page['landlord_code']}</td>";
echo "<td>{$page['property_id']}</td>";
echo "<td>{$page['property_location']}</td>";
echo "<td>".count_svalue('propertyunit','property_id',$page['property_id'])."</td>";
echo "<td>Ksh.".get_onesum('monthly_rent','propertyunit','property_id',$page['property_id'])."</td>";
...
$subject_pages=get_alltabledetails('property',$pagination->offset());
...
if(isset($_GET['propertyno']) ){
  ...
  if($vpagination->has_previous_page()){
   echo "<a href=\"propertylist.php?propertyno={$_GET['propertyno']}&pg={$pagination->previous_page()}\">&laquo; Previous</a>";
  }
  ...
  echo "<span class=\"selected\">{$i}</span>";
    ...
    echo " <a href=\"propertylist.php?propertyno={$_GET['propertyno']}&pg={$i}\">{$i}</a> ";
	//echo "<a href=\"index.php?subj=".urlencode($subject["id"])."&pg=\"{$i}\"\">{$i}</a>";
  }
  }
  if($vpagination->has_next_page()){
 echo "<a href=\"propertylist.php?propertyno={$_GET['propertyno']}&pg={$pagination->next_page()}\">Next &raquo;</a>";
  }
...
if($pagination->total_pages()>1){
  ...
  if($pagination->has_previous_page()){
   echo "<a href=\"propertylist.php?pg={$pagination->previous_page()}\">&laquo; Previous</a>";
  }
  ...
  echo "<span class=\"selected\">{$i}</span>";
    ...
    echo " <a href=\"propertylist.php?pg={$i}\">{$i}</a> ";
	//echo "<a href=\"index.php?subj=".urlencode($subject["id"])."&pg=\"{$i}\"\">{$i}</a>";
  }
  }
  if($pagination->has_next_page()){
 echo "<a href=\"propertylist.php?pg={$pagination->next_page()}\">Next &raquo;</a>";
  }
